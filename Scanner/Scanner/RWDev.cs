...
namespace UHF
{
    public static class RWDev
    {
        ...
        public static byte comAddress = 0xFF;
        public static byte QValue = 0;
        public static byte session = 0;
        public static byte TIDFlag = 0;
        public static byte target = 0;
        public static byte inAnt = 0;
        public static byte scantime = 0;
        public static byte fastFlag = 0;
        public static bool fIsInventoryScan;
        public static bool readerInit = false;
